...
def run_MD(path_atoms, path_calc, path_traj, start = 0, steps = 100, step = 50, temperature = None, pressure = None, seed = 0, num_cores = 1, precision = "single", device = "cpu"):
...
path_atoms = "input_struc.xyz"
#path_calc  = "MACE_MLP_cuda.model"
path_UMLP = "psiflow3_model.model"
path_traj  = "traj.xyz"
temp = float(sys.argv[1])
run_MD(path_atoms, path_UMLP, path_traj, start = 0, steps = 500000, step = 100, temperature = temp, pressure = 0.1 * 1e6 * molmod.units.pascal, device = "cuda")
